/**
 * Login İşlemlerini Test Etme Scripti (Backend içinde)
 */
  ...
  try {
    ...
    try {
      ...
      if (loginError.code === 'ECONNREFUSED') {
        console.error('   ⚠️  Backend çalışmıyor! Backend\'i başlatın: cd backend && npm start');
        process.exit(1);
      }
    }
    ...
    if (error.code === 'ECONNREFUSED') {
      console.error('\n⚠️  Backend çalışmıyor! Backend\'i başlatın:');
